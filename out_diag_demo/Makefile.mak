# SCI2C Makefile (Visual Studio 2008)
# hArtes EU Project.
# Authors: PoliBa & Inria & DIGITEO
# -----------------------
# --- USER PARAMETERS ---
# -----------------------
...
SCI2CDIR    = .
DIR_OBJ=Release
LAPACK_LIB =$(SCI2CDIR)/external-libs/lapack.lib
BLAS_LIB = $(SCI2CDIR)/external-libs/blasplus.lib
CC = cl
LINKER = link
...
CFLAGS =  $(CC_OPTIONS) -I"$(HSRCDIR)" -I"$(ISRCDIR)" /EHsc /TP 
EXEFILENAME = mytest
EXEFILE = $(SCI2CDIR)\$(EXEFILENAME)
MAIN_SRC = $(SCI2CDIR)/main.c
SRC = \
    $(CSRCDIR)/sabsa.c \
    $(CSRCDIR)/sabss.c \
    $(CSRCDIR)/zabsa.c \
    ...
    $(CSRCDIR)/u8inverma.c \
    $(CSRCDIR)/i8inverma.c \
    $(CSRCDIR)/u16inverma.c \
    $(CSRCDIR)/i16inverma.c \
    $(CSRCDIR)/sinfnorma.c \
    $(CSRCDIR)/dinfnorma.c \
    $(CSRCDIR)/zinfnorma.c \
    $(CSRCDIR)/cinfnorma.c \
    ...
    $(CSRCDIR)/i8uint16s.c \
    $(CSRCDIR)/i8uint16a.c \
    $(CSRCDIR)/i16uint16s.c \
    $(CSRCDIR)/i16uint16a.c \
    $(CSRCDIR)/dint16s.c \
    $(CSRCDIR)/dint16a.c \
    $(CSRCDIR)/sint16s.c \
    $(CSRCDIR)/sint16a.c \
    ...
    $(CSRCDIR)/u8bitands.c \
    $(CSRCDIR)/u8bitanda.c \
    $(CSRCDIR)/u16bitands.c \
    $(CSRCDIR)/u16bitanda.c \
    $(CSRCDIR)/u8bitors.c \
    $(CSRCDIR)/u8bitora.c \
    $(CSRCDIR)/u16bitors.c \
    $(CSRCDIR)/u16bitora.c \
    $(CSRCDIR)/u8bitxors.c \
    $(CSRCDIR)/u8bitxora.c \
    $(CSRCDIR)/u16bitxors.c \
    $(CSRCDIR)/u16bitxora.c \
    $(CSRCDIR)/u8bitcmps.c \
    $(CSRCDIR)/u8bitcmpa.c \
    $(CSRCDIR)/u16bitcmps.c \
    $(CSRCDIR)/u16bitcmpa.c \
    $(CSRCDIR)/u8bitsets.c \
    $(CSRCDIR)/u16bitsets.c \
    $(CSRCDIR)/u8bitgets.c \
    $(CSRCDIR)/u16bitgets.c \
    $(CSRCDIR)/dmaxa.c \
    $(CSRCDIR)/smaxa.c \
    $(CSRCDIR)/srowmaxa.c \
    $(CSRCDIR)/drowmaxa.c \
    ...
    $(CSRCDIR)/cmeanfa.c \
    $(CSRCDIR)/ccolumnmeanfa.c \
    $(CSRCDIR)/srowmeanfa.c \
    $(CSRCDIR)/drowmeanfa.c \
    $(CSRCDIR)/dmeanfa.c \
    $(CSRCDIR)/zrowmeanfa.c \
    $(CSRCDIR)/smeanfa.c \
    $(CSRCDIR)/scolumnmeanfa.c \
    $(CSRCDIR)/crowmeanfa.c \
    $(CSRCDIR)/dcolumnmeanfa.c \
    $(CSRCDIR)/zmeanfa.c \
    $(CSRCDIR)/zmeanfzd.c \
    $(CSRCDIR)/cmeanfcs.c \
    $(CSRCDIR)/zmeanfdz.c \
    $(CSRCDIR)/cmeanfsc.c \
    $(CSRCDIR)/zcolumnmeanfa.c \
    $(CSRCDIR)/srowproda.c \
    $(CSRCDIR)/drowproda.c \
    $(CSRCDIR)/dproda.c \
    $(CSRCDIR)/zrowproda.c \
    $(CSRCDIR)/sproda.c \
    $(CSRCDIR)/scolumnproda.c \
    $(CSRCDIR)/crowproda.c \
    $(CSRCDIR)/dcolumnproda.c \
    $(CSRCDIR)/zproda.c \
    $(CSRCDIR)/zcolumnproda.c \
    $(CSRCDIR)/cproda.c \
    $(CSRCDIR)/ccolumnproda.c \
    ...
    $(CSRCDIR)/cstdevfsc.c \
    $(CSRCDIR)/zstdevfdz.c \
    $(CSRCDIR)/dcolumnstdevfa.c \
    $(CSRCDIR)/dstdevfa.c \
    $(CSRCDIR)/crowstdevfa.c \
    $(CSRCDIR)/sstdevfa.c \
    $(CSRCDIR)/drowstdevfa.c \
    $(CSRCDIR)/srowstdevfa.c \
    $(CSRCDIR)/zcolumnstdevfa.c \
    $(CSRCDIR)/zrowstdevfa.c \
    $(CSRCDIR)/ccolumnstdevfa.c \
    $(CSRCDIR)/scolumnstdevfa.c \
    $(CSRCDIR)/cmula.c \
    $(CSRCDIR)/cmuls.c \
    $(CSRCDIR)/cmulv.c \
    $(CSRCDIR)/cmulcsv.c \
    ...
    $(CSRCDIR)/i8stringa.c \
    $(CSRCDIR)/i8strings.c \
    $(CSRCDIR)/u16stringa.c \
    $(CSRCDIR)/u16strings.c \
    $(CSRCDIR)/i16stringa.c \
    $(CSRCDIR)/i16strings.c \
    $(CSRCDIR)/dfft2.c \
    $(CSRCDIR)/cfftma.c \
    $(CSRCDIR)/r2tx.c \
    $(CSRCDIR)/r4tx.c \
    ...
    $(CSRCDIR)/clpc2cepa.c \
    $(CSRCDIR)/slpc2cepa.c \
    $(CSRCDIR)/dcrossCorra.c \
    $(CSRCDIR)/zcrossCorra.c \
    $(CSRCDIR)/scrossCorra.c \
    $(CSRCDIR)/ccrossCorra.c \
    $(CSRCDIR)/zconv2da.c \
    $(CSRCDIR)/cconv2da.c \
    $(CSRCDIR)/sconv2da.c \
    $(CSRCDIR)/dconv2da.c \
...
compileexecute: 
	...
	$(CC) $(CFLAGS) $(SRC) $(MAIN_SRC) /link $(LAPACK_LIB) $(BLAS_LIB) /out:$(EXEFILE).exe
	@echo " "
	@echo "=============="
	@echo "Executing code"
	@echo "=============="
